...
import time
from Neo4jQueryList import Neo4jQueryList
from Neo4jConnectorEE import Neo4jConnectorEE

class Neo4jListEE(Neo4jQueryList, Neo4jConnectorEE):
    def __init__(self, feature_file_name, label_file_name, edge_file_name, X_and_y_file_name, max_hops = 3):
        Neo4jQueryList.__init__(self, feature_file_name, label_file_name, edge_file_name, X_and_y_file_name)
        self.intialize_neo4j_list_data(feature_file_name, label_file_name, edge_file_name, X_and_y_file_name)
        self.initialize_all_queries_columns(max_hops)
        super(Neo4jConnectorEE, self).__init__()
        self.connect()
