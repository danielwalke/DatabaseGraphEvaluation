...
class PostgresQuery(Data):
    def __init__(self, feature_file_name, label_file_name, edge_file_name, X_and_y_file_name):
        ...
        self.create_node_columns_table_query = None
        self.create_node_list_table_query = None
        self.create_edge_table_query = None
    ...
    def set_create_node_columns_table(self):
        ...
        self.create_node_columns_table_query = f"""
        CREATE TABLE nodes (
            {",".join(column_types)}
        );
        """

    def set_create_edge_table(self):
        self.create_edge_table_query = """CREATE TABLE edges (
    ...
    def set_create_nodes_columns(self):
        self.create_nodes_columns_query = "COPY nodes FROM STDIN WITH (FORMAT CSV, HEADER TRUE, DELIMITER ',');"
    ...
    def initialize_all_queries_columns(self, max_hops):
        ...
        self.set_create_node_columns_table()
        self.set_create_edge_table()
